...
public final class RenderUtil
{
    ...
    private static int aoBrightnessXYNI;
    private static int aoBrightnessYZIN;
    private static int aoBrightnessYZIP;
    private static int aoBrightnessXYPI;
    private static int aoBrightnessXYZNIN;
    private static int aoBrightnessXYZNIP;
    private static int aoBrightnessXYZPIN;
    private static int aoBrightnessXYZPIP;
    ...
    private static float aoLightValueScratchXYNI;
    private static float aoLightValueScratchYZIN;
    private static float aoLightValueScratchYZIP;
    private static float aoLightValueScratchXYPI;
    private static float aoLightValueScratchXYZNIN;
    private static float aoLightValueScratchXYZNIP;
    private static float aoLightValueScratchXYZPIN;
    private static float aoLightValueScratchXYZPIP;
    ...
    private static void setupAOBrightnessYNeg (RenderBlocks renderer, Block block, int x, int y, int z, boolean bgXP, boolean bgXN, boolean bgZP, boolean bgZN) {
    ...
    private static void setupAOBrightnessYPos (RenderBlocks renderer, Block block, int x, int y, int z, boolean bgXP, boolean bgXN, boolean bgZP, boolean bgZN) {
    ...
    private static void mixAOBrightnessLightValueY (float fMin, float fMax) {
        if (fMin == 1 && fMax == 0) {
